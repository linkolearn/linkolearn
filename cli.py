...
Usage ``linkversity [OPTIONS] COMMAND [ARGS]...``

Example command 'welcome' has been added.
- To get your project version, run ``linkversity --version``
- Run the sample command as ``linkversity welcome [OPTIONS] NAME``
"""

from linkversity import __version__
import click
...
def welcome(name, verbose):
    ...
    """
    click.secho(f"Hi {name}. Welcome to linkversity", fg="cyan")
